...
public class HomeController {
	 ...
	 * 	<input name="str"> <button type="submit">전송</button>
	 * </form>
	 * 
	 * JST, HTML에서 위 코드를 만들고 입력화면을 보여준 후 
	...
	// localhost:8080/rootPath로 요청했을때
...
//		String fileName = fService.fileUp(files.get(0));
//		
//		model.addAttribute("file", fileName);
		
		List<String> fileNames = fService.filesUp(m_file);
	...
	public String home(@RequestParam("one_file")MultipartFile one_file,
		...
		log.debug("m_file 사이즈 : {}", m_file.getFile("m_file").getSize());
