...
public class StudentServiceImplV1 implements StudentService{
	...
	public String makeStNum() {
		...
		log.debug("현재 연도 {}", curYear, newStNum);
	...
	public String detail(Model model, String st_num) {
		...
		// 모델addAttribute는 return하지않아도됨 자동추가됨
	 ...
	 * 그중 CUD가 진행되는 동안 문제가 발생하고 데이터에 오류가 저장될 것이다.
	 * 
	 * 이런 상황을 방지하기 위하여
	...
	public String scoreInput(ScoreInputVO scInputVO) {
		...
		*/
		...
		/*
		 * @Transactional로 선언된 method에서 모든 데이터를 insertOrUpdate를 수행한 다음
