	...
	<section class="main_sec">
		<form method="POST">
			<fieldset>
				...
				<div>
					<label>저 자코드</label> <input name="au_code" id="au_code"
						placeholder="C0002" />
				</div>
				<div>
					<label>저자이름</label> <input name="au_name" id="au_name"
						placeholder="셜록홈즈" />
				</div>
				<div>
					<label>전화번호</label> <input name="au_tel" id="au_tel"
						placeholder="010-2233-4455" />
				</div>
				<div>
					<label>저자주소</label> <input name="au_addr" id="au_addr"
						placeholder="서울시 해운대구" />
				</div>
