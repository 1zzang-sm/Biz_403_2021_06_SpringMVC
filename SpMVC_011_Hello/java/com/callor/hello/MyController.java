...
public class MyController {
	...
	/*
	 * ReqeustMethod
	 * 일반적인 HTTP Server에서 (MVC패턴에서 대부분 사용함 GET,POST)
	 ...
	 * 		네트쿼크에 문제가 발생할 수 있어서 설정에서 일부 크기를 제한하기도 한다.
	 * 
	 *  서버입장에서
	 ...
	 * 
	 * 그런데, Java method의 변수를 String형이 아닌 것으로
	 * 		(숫자형, Boolean형 등)
	...
	public void insert(String temp, int num) {
